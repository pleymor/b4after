  ...
  return (
    <div data-testid="camera-denied" className="px-6 py-12 text-center text-slate-300">
      ...
      <p className="mt-2 text-sm">
        {status === 'denied'
          ? 'b4after a besoin de la caméra pour prendre une photo. Si le refus a été mémorisé, autorisez la caméra dans les réglages du navigateur pour ce site, puis réessayez.'
