...
**Conversion des coordonnées :** la surface de calage occupe une largeur CSS quelconque ; le réducteur attend des pixels du cadre canonique. On divise donc chaque coordonnée pointeur par le rapport `surfaceCssWidth / frameWidth`, mesuré avec `getBoundingClientRect`.
